...
export const createTournamentFeesApi = (tournamentId: string, fees: any[]) =>
  api.post(`/tournaments/${tournamentId}/fees`, { fees });

export const updateTournamentFeesApi = (tournamentId: string, fees: any[]) =>
  api.put(`/tournaments/${tournamentId}/fees`, { fees });

export const deleteTournamentFeeApi = (tournamentId: string, feeId: string) =>
